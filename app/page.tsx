...
export default function Home() {
  return (
    <main className="bg-slate-100 p-5 h-[100dvh] flex items-center justify-center dark:bg-black">
      <div className="gap-y-3 bg-white w-full shadow-md p-5 rounded-2xl max-w-screen-sm dark:bg-gray-400 flex flex-col">
